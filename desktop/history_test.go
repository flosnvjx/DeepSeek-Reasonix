...
func TestPreviewSessionMessagesIncludesProcessEvents(t *testing.T) {
	...
	body := strings.Join([]string{
		...
		`{"kind":"compaction_done","compaction":{"trigger":"manual","messages":6,"summary":"Kept the current task.","archive":"/data/data/com.termux/files/usr/tmp/archive.jsonl"}}`,
	...
	if got[3].Role != "compaction" || got[3].Pending || got[3].Messages != 6 || got[3].Summary != "Kept the current task." || got[3].Archive != "/data/data/com.termux/files/usr/tmp/archive.jsonl" {
