...
func TestWorkspaceGitBranchForMetaDoesNotBlockOnColdProbe(t *testing.T) {
	...
	start := time.Now()
	if got := workspaceGitBranchForMeta("/data/data/com.termux/files/usr/tmp/reasonix-cold-probe"); got != "" {
	...
	releaseProbe()
	eventuallyBranchForMeta(t, "/data/data/com.termux/files/usr/tmp/reasonix-cold-probe", "feature/async")
}

func TestWorkspaceGitBranchForMetaReturnsStaleDuringRefresh(t *testing.T) {
	resetWorkspaceGitBranchMetaCacheForTest(t)
	workspaceGitBranchCache.Lock()
	workspaceGitBranchCache.entries[filepath.Clean("/data/data/com.termux/files/usr/tmp/reasonix-stale-probe")] = workspaceGitBranchCacheEntry{
	...
	start := time.Now()
	if got := workspaceGitBranchForMeta("/data/data/com.termux/files/usr/tmp/reasonix-stale-probe"); got != "feature/stale" {
	...
	releaseProbe()
	eventuallyBranchForMeta(t, "/data/data/com.termux/files/usr/tmp/reasonix-stale-probe", "feature/fresh")
}
