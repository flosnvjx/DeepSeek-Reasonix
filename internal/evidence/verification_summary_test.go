...
func TestSwiftTestRecognizedAsVerification(t *testing.T) {
	...
	for _, command := range []string{
		...
		"swift test --xunit-output=report.xml",
		"swift test --scratch-path /data/data/com.termux/files/usr/tmp/out",
		"swift test --build-path /data/data/com.termux/files/usr/tmp/out",
		"swift test --build-path=/data/data/com.termux/files/usr/tmp/out",
		"swift test --event-stream-output-path /data/data/com.termux/files/usr/tmp/events.json",
		"swift test --experimental-event-stream-output /data/data/com.termux/files/usr/tmp/events.json",
		"swift test --attachments-path /data/data/com.termux/files/usr/tmp/attachments",
		"swift test --experimental-attachments-path /data/data/com.termux/files/usr/tmp/attachments",
		"swift test --cache-path /data/data/com.termux/files/usr/tmp/cache",
		"swift test --help",
...
func TestNpxVerificationUsesSafeKnownRunners(t *testing.T) {
	...
	for _, command := range []string{
		...
		"npx ./eslint src/",
		"npx /data/data/com.termux/files/usr/tmp/eslint src/",
		"npx playwright test",
		"npx cypress run",
		"npx tsx check.ts",
