...
func TestPastedImageSources(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			text: "![a](/data/data/com.termux/files/usr/tmp/a.png)\n![b](file:///data/data/com.termux/files/usr/tmp/b.jpg)",
			want: []string{"/data/data/com.termux/files/usr/tmp/a.png", "file:///data/data/com.termux/files/usr/tmp/b.jpg"},
			ok:   true,
		},
		{
		...
		},
		{
			...
			text: `/data/data/com.termux/files/usr/tmp/capture\(1\).png`,
			want: []string{`/data/data/com.termux/files/usr/tmp/capture\(1\).png`},
			ok:   true,
		},
		{
			name:      "multiple shell escaped paths on one line",
			text:      `/data/data/com.termux/files/usr/tmp/first\ image.png /data/data/com.termux/files/usr/tmp/second\ image.jpg`,
			want:      []string{`/data/data/com.termux/files/usr/tmp/first\ image.png`, `/data/data/com.termux/files/usr/tmp/second\ image.jpg`},
			ok:        true,
			posixOnly: true,
		},
		{
		...
		},
		{
			...
			text: `see /data/data/com.termux/files/usr/tmp/CleanShot\ 2026.png`,
			ok:   false,
		},
		{
			name: "plain text",
			text: "hello /data/data/com.termux/files/usr/tmp/a.png",
			ok:   false,
		},
	}
	for _, c := range cases {
...
func TestPastedImagePathShellUnescape(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			src:  `/data/data/com.termux/files/usr/tmp/capture\(1\).png`,
			goos: "linux",
			want: "/data/data/com.termux/files/usr/tmp/capture(1).png",
			ok:   true,
		},
		{
			name: "posix escaped spaces",
			src:  `/data/data/com.termux/files/usr/tmp/first\ image.png`,
			goos: "linux",
			want: "/data/data/com.termux/files/usr/tmp/first image.png",
			ok:   true,
		},
		{
			name: "posix escaped caret and comma",
			src:  `/data/data/com.termux/files/usr/tmp/capture\^1\,a.png`,
			goos: "linux",
			want: "/data/data/com.termux/files/usr/tmp/capture^1,a.png",
			ok:   true,
		},
		{
			name: "posix escaped literal backslash",
			src:  `/data/data/com.termux/files/usr/tmp/a\\b.png`,
			goos: "linux",
			want: `/data/data/com.termux/files/usr/tmp/a\b.png`,
			ok:   true,
		},
		{
